...
import hoaki from "../../assets/images/logo/logo-preview.png";
              ...
              <div className="wrap-box flex">
                        ...
                        {data.namesub && (
                          <ul className="sub-menu">
                            {data.namesub.map((submenu) => (
                              ...
                              >
                                <Link to={submenu.links}>{submenu.sub} dau roi</Link>
                              </li>
                            ))}
                          </ul>
                        )}
                ...
                <div className="flat-search-btn flex">
                  ...
                  <div className="sc-btn-top mg-r-12" id="site-header">
                    ...
                    {user && show === true ? (
                      <ul className="menu-profile" onBlur={() => setShow(false)} >
                        <li> <Link to="/mining">Profile</Link></li>
