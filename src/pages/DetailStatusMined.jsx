...
const DetailStatusMined = () => {
  ...
  //   const { data } = await loadDetailItem(id);
  //   setNft(data);
  // }
                ...
                <div className="sc-item-details">
                  ...
                  <div className="meta-item">
                    <div className="left">
                      ...
                      <span onClick={likeProjects} className="content_like">
                        <svg
                          width="25"
                          height="25"
                          viewBox="4 4 20 20"
                  ...
                  <div className="meta-item-details style2">
                    <div className="item meta-price">
                      <span className="heading">Mining Cost</span>
                      <div className="price">
                    ...
                    <div className="item count-down">
                      <span className="heading style-2 right">Mined in</span>
                      <span className="project-year">
                        {new Date(project[0]?.endTime)?.getFullYear()}
                      </span>
                    </div>
                  </div>
...
export default DetailStatusMined;
